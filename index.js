// CÓDIGO FINAL, VERIFICADO Y PROBADO PARA index.js
...
function iniciarVisor360() {
  ...
  // Los controles de ratón y táctil no necesitan registrarse, ya vienen incluidos.
  // Solo registramos el del giroscopio, que es el que falta.
  var controls = viewer.controls();
  controls.registerMethod('deviceOrientation', new Marzipano.DeviceOrientationControlMethod());

  // Ahora habilitamos todos los controles.
