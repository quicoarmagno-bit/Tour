...
// Crear y habilitar los controles de movimiento (giroscopio)
var controls = viewer.controls();
controls.enableMethod('drag'); // Control táctil (ya debería estar activo)
controls.enableMethod('mouseView'); // Control con el ratón
controls.enableMethod('deviceOrientation'); // ¡¡ESTA ES LA LÍNEAS MÁGICA!!
// **********************************
